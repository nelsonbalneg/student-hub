...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['module' => 'Dossiers', 'name' => 'dossiers.view'],
            ['module' => 'Dossiers', 'name' => 'dossiers.create'],
            ['module' => 'Dossiers', 'name' => 'dossiers.update'],
            ['module' => 'Dossiers', 'name' => 'dossiers.assign'],
            ['module' => 'Dossiers', 'name' => 'dossiers.transition'],
            ['module' => 'Dossiers', 'name' => 'dossiers.submit-review'],
            ['module' => 'Dossiers', 'name' => 'dossiers.approve'],
            ['module' => 'Dossiers', 'name' => 'dossiers.release'],
            ['module' => 'Dossiers', 'name' => 'dossiers.archive'],
            ['module' => 'Dossiers', 'name' => 'dossiers.download'],
            ['module' => 'Dossiers', 'name' => 'dossiers.documents.upload'],
            ['module' => 'Dossiers', 'name' => 'dossiers.documents.verify'],
