...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            ['module' => 'Evaluation Template', 'name' => 'evaluation.templates.view'],
            ['module' => 'Evaluation Template', 'name' => 'evaluation.templates.create'],
            ['module' => 'Evaluation Template', 'name' => 'evaluation.templates.update'],
            ['module' => 'Evaluation Template', 'name' => 'evaluation.templates.delete'],
