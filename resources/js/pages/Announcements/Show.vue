...
<template>
    ...
    <div class="flex h-full flex-1 flex-col bg-slate-50/60 dark:bg-slate-950">
            ...
            >
                <div class="flex min-w-0 items-start gap-3">
                    <Link
                        ...
                        class="inline-flex size-9 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-500 transition hover:border-slate-300 hover:text-slate-900 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10 dark:hover:text-white"
                    >
                    ...
                    <div class="min-w-0">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span
                                class="inline-flex items-center rounded-md border px-2 py-1 text-[10px] font-bold uppercase"
                                :style="{
                                    borderColor:
                                        announcement.category.color + '40',
                                    backgroundColor:
                                        announcement.category.color + '12',
                            ...
                            <span
                                ...
                                class="inline-flex items-center gap-1.5 rounded-md border border-sky-200 bg-sky-50 px-2 py-1 text-[10px] font-bold text-sky-700 uppercase dark:border-sky-400/30 dark:bg-sky-500/10 dark:text-sky-200"
                            >
                        ...
                        <h1
                            class="mt-2 max-w-4xl text-2xl font-bold tracking-normal text-slate-950 lg:text-3xl dark:text-white"
                        >
                            {{ announcement.title }}
                        </h1>

                        <div
                            class="mt-3 flex flex-wrap items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400"
                        >
                            <span
                                v-if="isSuperAdmin && announcement.creator"
                                class="inline-flex items-center gap-1.5 rounded-md border border-slate-200 bg-white px-2.5 py-1 dark:border-white/10 dark:bg-white/5"
                            >
                            ...
                            >
                                ...
                                {{
                                    format(
                                        new Date(announcement.publication_date),
                                        isSuperAdmin
                                            ? 'MMM d, yyyy h:mm a'
                                            : 'MMM d, yyyy',
                                    )
                ...
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                    <div
                        v-if="isSuperAdmin"
                        class="grid grid-cols-2 gap-1 rounded-lg border border-slate-200 bg-slate-50 p-1 dark:border-white/10 dark:bg-white/5"
                    >
                        <div
                        ...
                        >
                            ...
                            <p
                                class="text-xs font-bold text-slate-800 capitalize dark:text-slate-100"
                            >
                                {{ announcement.status }}
                            </p>
                        </div>
                    ...
                    <Link
                        ...
                        :href="announcementRoutes.edit.url(announcement.id)"
                    >
                        <Button
        ...
        <main class="grid w-full grid-cols-1 gap-5 p-4 lg:grid-cols-12 lg:p-6">
            <div
                class="space-y-5"
                :class="isSuperAdmin ? 'lg:col-span-8' : 'lg:col-span-12'"
            >
                <section
                ...
                >
                    ...
                    >
                        <div class="flex flex-wrap items-center gap-2">
                            <span
                                class="inline-flex items-center rounded-md border px-2.5 py-1 text-[10px] font-bold uppercase"
                                :style="{
                                    borderColor:
                                        announcement.category.color + '40',
                                    backgroundColor:
                            ...
                            <span
                                v-if="isSuperAdmin"
                                :class="[
                                    'inline-flex items-center rounded-md border px-2.5 py-1 text-[10px] font-bold uppercase',
                    ...
                    <div class="p-5 sm:p-7 lg:p-9">
                        <div
                            ...
                            class="mb-7 rounded-lg border border-sky-100 bg-sky-50/80 p-5 text-sm leading-7 font-semibold text-slate-700 dark:border-sky-400/20 dark:bg-sky-500/10 dark:text-slate-200"
                        >
                            {{ announcement.summary }}
                        </div>

                        <article
                            class="prose prose-slate prose-headings:font-bold prose-h1:tracking-normal prose-h2:tracking-normal prose-a:text-sky-600 prose-img:rounded-lg prose-table:text-sm dark:prose-invert max-w-none"
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-3 p-5 xl:grid-cols-2">
                        <div
                            v-if="announcement.attachments.length === 0"
                            class="rounded-lg border border-dashed border-slate-200 bg-slate-50 p-6 text-center xl:col-span-2 dark:border-white/10 dark:bg-white/5"
                        >
                            <FileText
                                class="mx-auto size-7 text-slate-300 dark:text-slate-600"
                            />
                            <p
                                class="mt-2 text-xs font-bold text-slate-400 uppercase"
                            >
                                No attached files
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            :key="attachment.id"
                            class="group flex flex-col gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4 transition hover:border-slate-300 hover:bg-white sm:flex-row sm:items-center sm:justify-between dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
                        >
                            <div class="flex min-w-0 items-center gap-3">
                                <div
                                    class="flex size-10 shrink-0 items-center justify-center rounded-md bg-white text-slate-500 shadow-sm dark:bg-slate-900"
                                >
                            ...
                            <div class="flex shrink-0 items-center gap-2">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener"
                                    class="inline-flex h-9 items-center justify-center gap-2 rounded-md border border-slate-200 bg-white px-3 text-xs font-bold text-slate-600 transition hover:border-sky-200 hover:bg-sky-50 hover:text-sky-700 dark:border-white/10 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-sky-500/10 dark:hover:text-sky-200"
                                >
                                    <Eye class="size-4" />
                                    Open
                                </a>
                                <a
                                    :href="attachmentUrl(attachment)"
                                    download
                                    class="inline-flex size-9 items-center justify-center rounded-md border border-slate-200 bg-white text-slate-500 transition hover:border-sky-200 hover:bg-sky-50 hover:text-sky-700 dark:border-white/10 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-sky-500/10 dark:hover:text-sky-200"
                                >
            ...
            <aside v-if="isSuperAdmin" class="space-y-5 lg:col-span-4">
                <div class="sticky top-6 space-y-5">
                    ...
                    >
                        ...
                        <div class="grid grid-cols-2 gap-3 p-5">
                            ...
                            >
                                ...
                                <p
                                    class="mt-1 text-sm font-bold text-slate-900 capitalize dark:text-white"
                                >
                                    {{ announcement.status }}
                                </p>
                            </div>
                            ...
                            >
                                ...
                                >
                                    {{
                                        announcement.visibility.replace(
                                            '_',
                                            ' ',
                                        )
                                    }}
                    ...
                    >
                        ...
                        <div class="p-5">
                            <div
                                class="relative space-y-6 before:absolute before:top-2 before:bottom-2 before:left-[7px] before:w-[2px] before:bg-slate-100 dark:before:bg-white/10"
                            >
                                <div class="relative pl-7">
                                    <div
                                        class="absolute top-1 left-0 size-3.5 rounded-full border-4 border-white bg-sky-500 shadow-sm dark:border-slate-950"
                                    ></div>
                                    <p
                                ...
                                >
                                    <div
                                        class="absolute top-1 left-0 size-3.5 rounded-full border-4 border-white bg-emerald-500 shadow-sm dark:border-slate-950"
                                    ></div>
                                    <p
                                        class="text-xs font-bold text-slate-900 dark:text-white"
                                    >
                                ...
                                >
                                    <div
                                        class="absolute top-1 left-0 size-3.5 rounded-full border-4 border-white bg-violet-500 shadow-sm dark:border-slate-950"
                                    ></div>
                                    <p
                                        class="text-xs font-bold text-slate-900 dark:text-white"
                                    >
                        ...
                        <div class="space-y-2 p-5">
                            <div
                                v-if="
                                    ...
                                    announcement.targets.length === 0
                                "
                                class="flex items-center gap-3 rounded-lg border border-dashed border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5"
                            >
                                <div
                                    class="flex size-9 shrink-0 items-center justify-center rounded-md bg-white text-slate-400 shadow-sm dark:bg-slate-900"
                                >
                                    <Users class="size-4" />
                                </div>
                                <div>
                            ...
                            <div
                                v-for="(target, index) in announcement.targets"
                                :key="index"
                            ...
                            >
                                ...
                                <div class="space-y-1">
                                    <div
                                        v-if="target.role"
                                        class="flex items-center justify-between gap-3 text-[11px] font-medium"
                                    >
                                        <span
                                            class="font-bold text-slate-500 uppercase"
                                            >Role</span
                                        >
                                        <span
                                            class="truncate font-bold text-slate-900 dark:text-white"
                                            >{{ target.role.name }}</span
                                        >
                                    </div>
                                    <div
                                        v-if="target.campus_id"
                                        class="flex items-center justify-between gap-3 text-[11px] font-medium"
                                    >
                                        <span
                                            class="font-bold text-slate-500 uppercase"
                                        ...
                                        <span
                                            class="truncate font-bold text-slate-900 dark:text-white"
                                            >{{ target.campus_id }}</span
                                        >
                                    </div>
                                    <div
                                        v-if="target.office_id"
                                        class="flex items-center justify-between gap-3 text-[11px] font-medium"
                                    >
                                        <span
                                            class="font-bold text-slate-500 uppercase"
                                        ...
                                        <span
                                            class="truncate font-bold text-slate-900 dark:text-white"
                                            >{{ target.office_id }}</span
                                        >
                                    </div>
                                    <div
                                        v-if="target.year_level"
                                        class="flex items-center justify-between gap-3 text-[11px] font-medium"
                                    >
                                        <span
                                            class="font-bold text-slate-500 uppercase"
