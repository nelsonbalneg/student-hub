            ...
            >
                <div class="flex min-w-0 items-center gap-3">
                    ...
                    <div class="min-w-0">
                        ...
                        >
                            Matched enrolled subjects for the current academic
                            term.
                        </p>
                    </div>
                </div>
                    ...
                    >
                        ...
                        >
                            <div class="min-w-0">
                                ...
                                <h3
                                    class="mt-2 text-base font-bold leading-snug text-slate-950 dark:text-white"
                                >
                        ...
                        <div class="grid gap-2 p-4 md:grid-cols-2">
                            ...
                            >
                                <div class="mb-2 flex items-center justify-between gap-2">
                                    ...
                                    >
                                        {{ index === 0 ? 'Schedule 1' : index === 1 ? 'Schedule 2' : `Schedule ${index + 1}` }}
                                    </span>
                                </div>
