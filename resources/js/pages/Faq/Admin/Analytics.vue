...
const helpfulnessChartSeries = [
    props.helpfulnessStats.helpful,
    props.helpfulnessStats.not_helpful,
];
...
const viewedChartOptions = {
    ...
    dataLabels: { enabled: false },
    xaxis: {
        categories: props.mostViewed.map(
            (v) => v.question.substring(0, 30) + '...',
        ),
    },
    colors: ['#10b981'],
};
...
const totalViews = computed(() =>
    props.mostViewed.reduce((a, b) => a + b.view_count, 0),
);
const totalSearches = computed(() =>
    props.searchTrends.reduce((a, b) => a + b.count, 0),
);
</script>
...
<template>
    ...
    >
                ...
                <div class="min-w-0">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            >
                                Track article engagement, search trends, and
                                user feedback.
                            </p>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div
                class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-slate-900"
            >
                <div class="flex items-center justify-between">
                    <div
                        class="rounded-lg bg-emerald-50 p-2 text-emerald-600 dark:bg-emerald-500/10"
                    >
                        <Eye class="size-5" />
                    </div>
                    <span
            ...
            >
                <div class="flex items-center justify-between">
                    <div
                        class="rounded-lg bg-blue-50 p-2 text-blue-600 dark:bg-blue-500/10"
                    >
                        <Search class="size-5" />
                    </div>
                    <span
            ...
            >
                <div class="flex items-center justify-between">
                    <div
                        class="rounded-lg bg-amber-50 p-2 text-amber-600 dark:bg-amber-500/10"
                    >
                ...
                <div class="mt-4">
                    ...
                    >
                        {{
                            helpfulnessStats.helpful +
                                helpfulnessStats.not_helpful >
                            0
                                ? Math.round(
                                      (helpfulnessStats.helpful /
                                          (helpfulnessStats.helpful +
            ...
            >
                <div class="flex items-center justify-between">
                    <div
                        class="rounded-lg bg-purple-50 p-2 text-purple-600 dark:bg-purple-500/10"
                    >
                        <HelpCircle class="size-5" />
                    </div>
                    <span
                        class="text-[10px] font-bold tracking-widest text-purple-600 uppercase"
                        >Inventory</span
                    >
                </div>
                <div class="mt-4">
                    ...
                    >
                        {{
                            categoryStats.reduce((a, b) => a + b.faqs_count, 0)
                        }}
                    </h3>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div
                class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-slate-900"
            >
            ...
            >
                ...
                <VueApexCharts
                    height="300"
                    :options="helpfulnessChartOptions"
                    :series="helpfulnessChartSeries"
                />
                <div class="mt-4 grid grid-cols-2 gap-4">
                    <div
                        class="rounded-lg bg-emerald-50 p-3 text-center dark:bg-emerald-500/10"
                    >
                        <span
                            class="block text-xl font-bold text-emerald-700 dark:text-emerald-400"
                            >{{ helpfulnessStats.helpful }}</span
                        >
                        <span
                            class="text-[10px] font-bold text-emerald-600/60 uppercase"
                            >Helpful</span
                        >
                    </div>
                    <div
                        class="rounded-lg bg-rose-50 p-3 text-center dark:bg-rose-500/10"
                    >
                        <span
                            class="block text-xl font-bold text-rose-700 dark:text-rose-400"
                            >{{ helpfulnessStats.not_helpful }}</span
                        >
                        <span
                            class="text-[10px] font-bold text-rose-600/60 uppercase"
                            >Not Helpful</span
                        >
                    </div>
                </div>
            ...
            >
                ...
                <div class="flex-1 overflow-auto">
                    <div
                        ...
                        :key="trend.keyword"
                        class="flex items-center justify-between border-b border-slate-100 py-3 last:border-0 dark:border-white/5"
                    >
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            >
                            <div
                                class="h-1 w-12 overflow-hidden rounded-full bg-slate-100 dark:bg-white/5"
                            >
                                <div
                    ...
                    <div
                        v-if="searchTrends.length === 0"
                        class="flex h-full flex-col items-center justify-center py-10 opacity-50"
                    >
                        <Search class="mb-2 size-8" />
                        <span class="text-xs font-bold"
                            >No search data yet</span
                        >
                    </div>
                </div>
            </div>
