...
const getVisibilityColor = (visibility: string) => {
    switch (visibility) {
        ...
        default:
            return 'text-slate-600 bg-slate-50 dark:bg-white/5';
    }
};
</script>
...
<template>
        ...
        <section class="border-b border-slate-200 pb-5 dark:border-white/10">
            ...
            >
                <div class="min-w-0">
                    ...
                    >
                        Manage groupings for your frequently asked questions to
                        help users navigate content efficiently.
                    </p>
                </div>
        ...
        >
            ...
            <div class="relative min-h-0 w-full flex-1 overflow-auto">
                <table class="w-full text-sm">
                    ...
                    >
                        <tr>
                            <th class="w-[250px] px-4 py-3">Category</th>
                        ...
                        >
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-black/5 dark:border-white/10"
                                        :style="{
                                            backgroundColor:
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span
                                        class="text-[11px] font-bold text-slate-600 capitalize dark:text-slate-300"
                                        >{{ category.visibility }}</span
                                    >
                                </div>
                            </td>
                            <td
                                class="px-4 py-3 text-center font-mono text-[11px] text-slate-500 dark:text-slate-400"
                            >
                                {{ category.sort_order }}
                            </td>
                            <td class="px-4 py-3 text-center">
                                <span
                                    class="inline-flex h-5 items-center justify-center rounded-full bg-slate-100 px-2 text-[10px] font-bold text-slate-600 dark:bg-white/5 dark:text-slate-400"
                                >
                        ...
                        <tr v-if="categories.data.length === 0">
                            <td colspan="6" class="p-12 text-center">
                                ...
                                >
                                    ...
                                    >
                                        Initialize your knowledge base by
                                        creating a category.
                                    </p>
                                </div>
                            </td>
    ...
    >
        <div
            class="w-full max-w-lg animate-in rounded-xl border bg-card p-6 shadow-2xl duration-200 fade-in zoom-in dark:bg-slate-900"
        >
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500">
                            Classify related questions for easier navigation.
                        </p>
                    </div>
                </div>
                <Button
            ...
            <form @submit.prevent="submit" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex gap-2">
                            <input
                                v-model="form.color"
                                type="color"
                                class="h-10 w-12 cursor-pointer rounded-lg border border-slate-200 p-1 shadow-sm dark:border-white/10 dark:bg-slate-950"
                            />
                            <input
                                v-model="form.color"
                                class="flex h-10 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 font-mono text-xs text-slate-900 shadow-sm focus:border-emerald-400 focus:outline-none dark:border-white/10 dark:bg-slate-950 dark:text-slate-100"
                            />
                        </div>
                    ...
                    <div class="flex items-center gap-3 pt-6 pl-2">
                        ...
                        >
                            ...
                            <span
                                class="text-sm font-bold text-slate-700 transition-colors group-hover:text-emerald-600 dark:text-slate-300"
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea
                        ...
                        class="flex min-h-[80px] w-full resize-none rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-900 shadow-sm focus:border-emerald-400 focus:outline-none dark:border-white/10 dark:bg-slate-950 dark:text-slate-100"
                ...
                <div class="flex justify-end gap-3 pt-4">
                    ...
                    <Button
                        ...
                        class="border-0 bg-emerald-600 px-6 font-bold text-white shadow-lg shadow-emerald-200 hover:bg-emerald-700 dark:shadow-none"
                    >
                        <Loader2
    ...
    >
        ...
        >
            ...
            <p class="mb-6 text-sm text-muted-foreground">
                ...
                >? If this category has associated FAQs, deletion may be
                blocked. This action cannot be reversed.
            </p>
