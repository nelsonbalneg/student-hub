...
const activeFilterCount = computed(
    () =>
        [
            ...
            props.can.viewTermId ? filters.value.term_id : '',
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-5 p-4 lg:p-6">
        <section class="border-b border-slate-200 pb-5 dark:border-white/10">
            ...
            >
                <div class="min-w-0">
                    ...
                    >
                        Request and manage internet accounts for the current
                        active term.
                    </p>
                </div>
                ...
                <table class="w-full min-w-[900px] text-sm">
                    ...
                    >
                        <tr>
                            ...
                            <th v-if="can.viewTermId" class="px-4 py-3">
                                Term ID
                            </th>
        ...
        <div
            v-if="editModalOpen && selectedRequest"
            class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm"
            @click.self="editModalOpen = false"
        >
            <div
                class="w-full max-w-md rounded-lg border border-slate-200 bg-white shadow-2xl dark:border-white/10 dark:bg-slate-950"
            >
                <div
                ...
                >
                    ...
                    >
                        Update request details for
                        {{
                            selectedRequest.student_name ||
                            selectedRequest.student_no
                        }}.
                    </p>
                </div>
                ...
                <form
                    ...
                    @submit.prevent="askEditConfirmation"
                >
                    <label
                    ...
                    >
                        ...
                        <textarea
                            ...
                            placeholder="Required context for failed requests"
                        ></textarea>
