    ...
    <SiteSettingsLayout>
        <div class="space-y-10 p-6 lg:p-10">
            ...
            >
                <div>
                    ...
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Manage your campus identities and academic
                        configurations.
                    </p>
                </div>
                <Button
                    @click="showCreateModal = true"
                    class="bg-sky-600 text-white shadow-lg shadow-sky-500/20 hover:bg-sky-700"
                >
            ...
            <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <Card
                    v-for="campus in campuses.data"
                    :key="campus.id"
                    class="group relative overflow-hidden transition-all hover:shadow-md dark:bg-slate-900/50"
                >
                    <CardContent class="p-5">
                        <div class="flex items-start justify-between gap-4">
                            <div class="flex items-center gap-4">
                                <div
                                    class="relative flex size-12 items-center justify-center rounded-xl bg-slate-100 ring-1 ring-slate-200 dark:bg-white/5 dark:ring-white/10"
                                >
                                    <img
                                        v-if="campus.campus_logo_path"
                                        :src="`/storage/${campus.campus_logo_path}`"
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger as-child>
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        class="size-8 rounded-full opacity-0 transition-opacity group-hover:opacity-100"
                                    >
                        ...
                        <Link
                            :href="campusRoutes.show.url(campus.id)"
                            class="mt-4 flex w-full items-center justify-center rounded-lg bg-slate-50 py-2 text-xs font-bold text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:bg-white/5 dark:text-slate-400 dark:hover:bg-white/10 dark:hover:text-white"
                        >
                            View Details
            ...
            <!-- Empty State -->
            <div
                v-if="campuses.data.length === 0"
                class="flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 py-20 dark:border-white/5"
            >
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Get started by creating your first campus identity.
                </p>
                <Button
                    @click="showCreateModal = true"
                    variant="outline"
            ...
            <Dialog v-model:open="showCreateModal">
                <DialogContent class="sm:max-w-[425px]">
                    <DialogHeader>
                        ...
                        <DialogDescription
                            >Add a new campus identity to the
            ...
            <Dialog v-model:open="showEditModal">
                <DialogContent class="sm:max-w-[425px]">
                    ...
                    <form @submit.prevent="updateCampus" class="space-y-4 py-4">
                        ...
                        <div class="space-y-2">
                            <Label for="edit_logo"
                                >Campus Logo (Leave blank to keep
                                current)</Label
                            >
                            <Input
                                id="edit_logo"
