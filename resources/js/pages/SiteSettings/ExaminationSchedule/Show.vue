        ...
        <div class="flex h-full flex-col p-4 sm:p-6 lg:p-8">
            <div class="mb-6 flex items-center gap-4">
                ...
                <div>
                    ...
                    <div
                        class="mt-1 flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400"
                    >
                        <span
            ...
            >
                <h3
                    class="flex items-center gap-2 text-base font-semibold text-emerald-900 dark:text-emerald-300"
                >
                    <FileSpreadsheet class="size-5" />
                    Import Subjects Data
                </h3>
                <p
                    class="mt-1 text-sm text-emerald-700/80 dark:text-emerald-400/80"
                >
                ...
                >
                    <input
                        ...
                        type="file"
                        accept=".xlsx,.xls,.csv"
                        class="block w-full max-w-md text-sm text-slate-500 file:mr-4 file:rounded-lg file:border-0 file:bg-emerald-100 file:px-4 file:py-2 file:text-sm file:font-medium file:text-emerald-700 hover:file:bg-emerald-200 dark:text-slate-400 dark:file:bg-emerald-500/20 dark:file:text-emerald-300"
                        @change="selectImportFile"
                    />
                    <button
                        type="button"
                        :disabled="!selectedFile || previewLoading"
                        class="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
                        @click="previewImport"
                    >
                        <Upload class="size-4" />
                ...
                >
                    ...
                    <div class="max-h-80 overflow-auto">
                        <table class="min-w-full text-left">
                            <thead
                                class="sticky top-0 bg-slate-50 text-[10px] text-slate-500 uppercase dark:bg-slate-900"
                            >
                                <tr>
                            ...
                            <tbody
                                class="divide-y divide-slate-100 text-xs dark:divide-white/5"
                            >
                                <tr
                    ...
                    >
                        ...
                        <div class="flex justify-end gap-2">
                            <button
                                type="button"
                                class="h-9 rounded-lg px-3 text-xs font-medium text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/5"
                                @click="resetImport"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                :disabled="
                                    ...
                                    syncLoading
                                "
                                class="h-9 rounded-lg bg-emerald-600 px-4 text-xs font-medium text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
                                @click="syncImport"
                            >
                                {{
                                    syncLoading
                ...
                <div class="mb-4 flex items-center justify-between">
                    <div class="relative w-full max-w-sm">
                        <input
                            ...
                            class="block w-full rounded-xl border-slate-300 pl-10 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 sm:text-sm dark:border-white/10 dark:bg-slate-800 dark:text-white"
                        />
                        <Search
                ...
                >
                    <div class="overflow-x-auto">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <td
                                        class="px-6 py-3 text-sm font-medium whitespace-nowrap text-slate-900 dark:text-white"
                                    >
                                        {{ record.subject_code }}
                                    </td>
                                    <td
                                        class="px-6 py-3 text-sm whitespace-nowrap text-slate-500 dark:text-slate-400"
                                    >
                                        {{ record.section || '-' }}
                                    </td>
                                    <td
                    ...
                    >
                        <button
                            ...
                            class="text-sm font-medium text-emerald-600 disabled:opacity-50 dark:text-emerald-400"
                        >
                            Previous
                        </button>
                    ...
                    >
                        ...
                        <div class="mt-4 grid grid-cols-4 gap-4">
                            ...
                            >
                                ...
                                <p
                                    class="mt-1 text-lg font-bold text-rose-700 dark:text-rose-400"
                                >
                                    {{ log.failed_rows }}
                                </p>
                            </div>
                        ...
                        >
                            ...
                            <ul
                                class="max-h-32 overflow-y-auto rounded-lg bg-rose-50 p-3 text-xs text-rose-800 dark:bg-rose-500/10 dark:text-rose-300"
                            >
                                <li
                                    v-for="(
                                        error, i
