...
<template>
    ...
    >
        <div class="mx-auto max-w-7xl space-y-6">
            ...
            <div v-if="society" class="grid gap-5 lg:grid-cols-[1.2fr_0.8fr]">
                ...
                >
                    <div class="flex items-start gap-4">
                        <div
                            class="flex size-12 items-center justify-center rounded-md bg-sky-50 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300"
                        >
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-slate-500">
                                ...
                                {{ society.college_unit ?? society.college }}
                            </p>
                            <p
                                class="mt-3 max-w-2xl text-sm text-slate-600 dark:text-slate-300"
                            >
                                {{
                                    society.description ??
                ...
                <section class="grid grid-cols-2 gap-3">
                    ...
                    >
                        ...
                        <p
                            class="mt-3 text-xs font-black tracking-wider text-slate-500 uppercase"
                        >
                            Application
                        </p>
                        <p
                    ...
                    >
                        ...
                        <p
                            class="text-lg font-black text-slate-950 dark:text-white"
                        >
                            {{ society.officers?.length ?? 0 }}
                        </p>
                    </Link>
                    <Link
                        :href="`/societies/manage/${society.id}/members-roster`"
                        class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900"
                    >
                    ...
                    <Link
                        :href="`/societies/manage/${society.id}/bylaws`"
                        class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900"
                    >
            ...
            <div
                v-else
                class="rounded-lg border border-dashed border-slate-300 bg-white p-10 text-center dark:border-slate-700 dark:bg-slate-900"
            >
                <h2 class="text-lg font-black text-slate-950 dark:text-white">
                    No society profile yet
                </h2>
                <p class="mt-2 text-sm text-slate-500">
                    Create the organization profile first, then submit semestral
                    accreditation.
                </p>
            </div>
        </div>
