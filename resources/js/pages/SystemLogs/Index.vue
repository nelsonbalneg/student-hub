...
<template>
            ...
            >
                ...
                <div class="divide-y divide-slate-100 dark:divide-white/10">
                    <Link
                        ...
                        :key="file.name"
                        :href="
                            logsIndex.url(query({ file: file.name, page: 1 }))
                        "
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            >
                                {{ entries.from || 0 }}-{{ entries.to || 0 }} of
                                {{ entries.total }}
                                entries
                            </p>
                        </div>
                        <div class="flex flex-wrap gap-2">
                            <a
                                v-if="can.download && selectedFile"
                                :href="
                                    exportMethod.url(query({ format: 'txt' }))
                                "
                            ...
                            <tr v-if="entries.data.length === 0">
                                <td colspan="5" class="px-4 py-12 text-center">
                                    ...
                                    <p
                                        class="mt-1 text-xs text-slate-500 dark:text-slate-400"
                                    >
                                        Try widening the date range or clearing
                                        filters.
                                    </p>
                                </td>
                            </tr>
    ...
    >
        ...
        >
            ...
            <div class="max-h-[calc(90vh-88px)] space-y-5 overflow-y-auto p-5">
                <div
                ...
                <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                    <div class="rounded-lg bg-slate-50 p-3 dark:bg-white/5">
                        ...
                        >
                            {{ selectedEntry.exception_type || 'Not detected' }}
                        </p>
                    </div>
                    <div class="rounded-lg bg-slate-50 p-3 dark:bg-white/5">
                        <p
